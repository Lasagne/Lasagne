...
def main(model='mlp', num_epochs=500):
    ...
    train_ds = lasagne.data_source.ArrayDataSource([X_train, y_train])
    val_ds = lasagne.data_source.ArrayDataSource([X_val, y_val])
    test_ds = lasagne.data_source.ArrayDataSource([X_test, y_test])
