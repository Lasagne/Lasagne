...
from pylearn2.cuda_convnet.filter_acts import FilterActs
...
class Conv2DCCLayer(BaseConvLayer):
    ...
    ``pylearn2.cuda_convnet.filter_acts.FilterActs``.
...
class MaxPool2DCCLayer(Layer):
    ...
    pylearn2: ``pylearn2.cuda_convnet.pool.MaxPool``.
    ...
    * this layer only works on the GPU.
    ...
    def __init__(self, incoming, pool_size, stride=None, ignore_border=False,
        ...
        from pylearn2.cuda_convnet.pool import MaxPool
