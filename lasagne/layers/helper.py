...
def get_all_layers(layer):
    ...
    ----------
    layer : Layer or list
        The :class:`Layer` instance for which to gather all layers feeding into
        it, or a list of :class:`Layer` instances.
    ...
    layers : list
        ...
        either directly or indirectly, and the given instance(s) themselves, in
        topological order.
    """
    import warnings
