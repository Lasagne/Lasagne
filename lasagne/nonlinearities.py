...
low_temperature_softmax.__doc__ = """low_temperature_softmax(x)

     Instance of :class:`TemperatureSoftmax` with temperature :math:`\\T=0.1`
     """


high_temperature_softmax = TemperatureSoftmax(temperature=3)
high_temperature_softmax.__doc__ = """high_temperature_softmax(x)

     Instance of :class:`TemperatureSoftmax` with temperature :math:`\\T=3`
     """
