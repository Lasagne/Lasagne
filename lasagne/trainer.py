...
def _get_network_params(layer, updates=None):
    """
    Get the parameters of a neural network where `layer` is the final
    layer or list of final layers. The only difference between this function
    and :func:`lasagne.layers.get_all_params` is that it will supplement
    the list of parameter with those introduced by updates.
    ...
    updates : `None` or list/dict of updates generated by functions in the
        :mod:`lasagne.updates` module
